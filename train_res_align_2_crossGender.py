...
def train_fn(net, train_loader, loss_fn, loss_fn_2, optimizer):
    ...
    for batch_idx, data in enumerate(train_loader):
        ...
        align_target = get_align_target(label)
...
def map_fn(flags):
    model_name = f'Res50_All_align_cossGender'
...
if __name__ == "__main__":
    ...
    save_path = '../../autodl-tmp/Res50_AllPre_1_100epoch_align2_crossGender'
