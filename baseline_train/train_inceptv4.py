...
import time
from model import baseline, get_My_inceptionv4


def map_fn(flags):
    model_name = f'inceptionv4_CE_All_woPre'
    # Acquires the (unique) Cloud TPU core corresponding to this process's index
    # gpus = [0, 1]
    # torch.cuda.set_device('cuda:{}'.format(gpus[0]))

    mymodel = baseline(32, *get_My_inceptionv4()).cuda()
...
if __name__ == "__main__":
    ...
    save_path = '../../../autodl-tmp/inceptv4_All_woPre'
